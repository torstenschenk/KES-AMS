...
proc create_root_design { parentCell } {
  ...
  set leds_8bits_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 leds_8bits_0 ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports leds_8bits_0] [get_bd_intf_pins axi_gpio_1/GPIO]
