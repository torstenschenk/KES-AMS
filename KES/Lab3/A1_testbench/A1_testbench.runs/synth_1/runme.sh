...
HD_PWD='C:/Users/omid/Documents/GitHub/KES-AMS/KES/Lab3/A1_testbench/A1_testbench.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logic_demo.vds -m64 -mode batch -messageDb vivado.pb -notrace -source logic_demo.tcl
