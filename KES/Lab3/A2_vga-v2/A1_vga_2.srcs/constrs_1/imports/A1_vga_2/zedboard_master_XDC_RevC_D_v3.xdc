...
# VGA Output - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y21  [get_ports {s00_blue[0]}];  # "VGA-B1"
set_property PACKAGE_PIN Y20  [get_ports {s00_blue[1]}];  # "VGA-B2"
set_property PACKAGE_PIN AB20 [get_ports {s00_blue[2]}];  # "VGA-B3"
set_property PACKAGE_PIN AB19 [get_ports {s00_blue[3]}];  # "VGA-B4"
set_property PACKAGE_PIN AB22 [get_ports {s00_green[0]}];  # "VGA-G1"
set_property PACKAGE_PIN AA22 [get_ports {s00_green[1]}];  # "VGA-G2"
set_property PACKAGE_PIN AB21 [get_ports {s00_green[2]}];  # "VGA-G3"
set_property PACKAGE_PIN AA21 [get_ports {s00_green[3]}];  # "VGA-G4"
set_property PACKAGE_PIN AA19 [get_ports {s00_hSync}];  # "VGA-HS"
set_property PACKAGE_PIN V20  [get_ports {s00_red[0]}];  # "VGA-R1"
set_property PACKAGE_PIN U20  [get_ports {s00_red[1]}];  # "VGA-R2"
set_property PACKAGE_PIN V19  [get_ports {s00_red[2]}];  # "VGA-R3"
set_property PACKAGE_PIN V18  [get_ports {s00_red[3]}];  # "VGA-R4"
set_property PACKAGE_PIN Y19  [get_ports {s00_vSync}];  # "VGA-VS"
